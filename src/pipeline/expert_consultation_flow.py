...
# ======================================
# Expert Consultation & Policy Synthesis
# ======================================
...
class ExpertConsultationFlow:
    ...
    def run(self) -> Dict:
        """
        Run expert evaluation and policy synthesis.
        """
        ...
        environmental_assessment = self.expert_council.run_environmental_assessment(
            debate_data
        )
        economic_assessment = self.expert_council.run_economic_assessment(
            debate_data
        )
    ...
    def _save_outputs(self, synthesis: Dict):
        """
        Persist expert outputs as separate research artifacts.
        """
        self._save_json(
            synthesis["environmental_assessment"],
            "environmental_assessment.json"
        )
        self._save_json(
            synthesis["economic_assessment"],
            "economic_assessment.json"
        )
        self._save_json(
            synthesis["conflict_matrix"],
